...
public abstract class ClassUtils {
	 ...
	 * the same as, or is a superclass or superinterface of,
	 * the class or interface represented by the specified Class parameter
	 *
	 * Function Description:
	 * Firstly, use isAssignableFrom​() to determines
	 * if the class or interface represented by this Class object is either
	 * the same as, or is a superclass or superinterface of,
	 * the class or interface represented by the specified Class parameter
	 */
